...
int pa1functions::Run(){
	...
	newtonOutput = NewtonsMethod( NEWTON_X0, NEWTON_MAX, NEWTON_DELTA, NEWTON_EPSILON );
	secantOutput = SecantMethod( SECANT_A, SECANT_B, SECANT_MAX, SECANT_DELTA, SECANT_EPSILON );
